...
<div class="container" style="padding-bottom: 30px;">
    <div class="row" style="margin-top: 30px;margin-bottom: 30px;">
        <div class="col-md-9">
           <a href="buzon.php" class="btn btn-sm btn-outline-primary" style="margin-bottom:10px;">Regresar</a>
            <div id="chat" class="card" style="border-color: #e67e22;">
                <div class="card-header h3 text-white" style="background-color: #e67e22;">"<?php echo $mensaje['titulo'] ?>"</div>
                <div class="card-body">
