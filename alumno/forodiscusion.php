    ...
    <div class="row" style="margin-top: 30px;margin-bottom: 30px;">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="escribir_post.php" class="btn btn-outline-info">Escribir Publicación</a>
                    <br>
                    <br>
                    <?php if (!empty($posts)): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm text-left"><a href="forodiscusion.php?p=<?php echo pagina_actual() - 1; ?>" class="btn btn-secondary">Página Anterior</a></div>
                        <?php endif ?>
                            <div class="col-sm text-center">Página <?php echo $pagina_actual?> de <?php echo $num_pag?></div>
                        <?php if ($pagina_actual < $num_pag): ?>
                            <div class=" col-sm text-right"><a href="forodiscusion.php?p=<?php echo pagina_actual() + 1; ?>" class="btn btn-secondary">Siguiente Página</a></div>
                        <?php endif ?>
                        </div>
                        <?php else: ?>
                        <p class="text-muted text-center h4">Aun no hay publicaciones...</p>                    
                        <?php endif ?>                       
                </div>
            </div>
        </div>
