       ...
       <div class="nav navbar sticky-top" style="background-color: #fff;">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav mr-auto">
                <li class="nav-item navegacion-ad"><a class="nav-link text-light" href="index.php"><div class="h4"><i class="material-icons">home</i> Inicio</div></a></li>
            </ul>
            <a class="btn btn-sm btn-wine" href="../index.php">Cerrar Sesión</a>
        </div>
    </nav>
    <nav class="navbar text-light justify-content-center bg-wine-dark">
        <div class="navbar-expand-sm">
            <div class="text-capitalize">Bienvenido: Administrador</div>
        </div>
    </nav>
    </div>
