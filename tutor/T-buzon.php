...
$statement = $conexion->prepare("SELECT * FROM mensajes WHERE receptor = :id_usuario and fk_grupop= :g OR receptor = :id_usuario and fk_grupop= 8 ORDER BY `mensajes`.`fecha` DESC");
$statement->execute(array(":id_usuario" => $_SESSION['usuario']['0'],":g"=> $_GET['g']));
$mensajes =$statement->fetchAll();

$stat2 = $conexion->prepare("SELECT * FROM mensajes WHERE emisor = :id_usuario and fk_grupop= :g  ORDER BY `mensajes`.`fecha` DESC");
$stat2->execute(array(":id_usuario" => $_SESSION['usuario']['0'], ":g"=> $_GET['g']));
            ...
            <div id="chat" class="card" style="border-color: #e67e22; max-height: 400px;">
                ...
                <div class="card-body" style="overflow-y: scroll;">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <a href="mensaje.php?id=<?php echo $enviado['id_mensaje'];?>&g=<?php echo $_GET['g']; ?>" class="card border-secondary post" style="margin-bottom: 5px">
                            <div class="card-body text-dark">
                                <div class="row">
                ...
                <div class="card-footer text-right">
                    <a href="escribir_mensaje.php?g=<?php echo $_GET['g']; ?>" class="btn btn-outline-info">Escribir Mensaje</a>
                </div>
            </div>
        </div>
