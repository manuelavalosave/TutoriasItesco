...
if ($_SESSION['usuario']['3'] == '2') {
    ...
    include_once '../app/op_tutor_pub_post.php';
}else{
    session_destroy();
        ...
        <div class="col-md-9">
           <div style="padding-bottom: 5px;"><a href="forodiscusion.php" class="h4 btn btn-sm btn-outline-primary">Regresar</a></div>
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="../app/op_tutor_pub_post.php">
                        ...
                        <textarea class="form-control" name="contenido" id="contenido" style="max-height: 150px; min-height:150px;" required></textarea>
                        <br>
                        <?php if (isset($error)): ?>
