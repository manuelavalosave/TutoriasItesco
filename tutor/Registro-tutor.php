...
<!--<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">-->
    <center><h3>PLAN DE TRABAJO DEL TUTOR PARA SESION PRESENCIAL</h3></center>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <input type="text" name="" id="actividad_realizar" class="form-control input-sm">
          <label>Ojetivo de la actividad</label>
          <input type="text" name="" id="objetivo_realizar" class="form-control input-sm">
            <label>Material a utilizar</label>
            <input type="text" name="" id="material_utilizar" class="form-control input-sm">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <label>Actividad a realizar</label>
            <input type="text" name="" id="actividad_realizaru" class="form-control input-sm">
          <label>Ojetivo de la actividad</label>
          <input type="text" name="" id="objetivo_realizaru" class="form-control input-sm">
            <label>Material a utilizar</label>
            <input type="text" name="" id="material_utilizaru" class="form-control input-sm">
        ...
        <div class="row" style="padding-top: 30px;padding-bottom: 100px;">
            ...
            <div class="col-md-8">
                ...
                <div class="card border-info">
                    <div class="card-header border-info text-light h5 bg-info">PLAN DE TRABAJO</div>
                    <div class="card-body">
                      <div class="container">
    <!--<div id="buscador"></div>-->
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#guardarnuevo').click(function(){
          ...
          actividad_realizar=$('#actividad_realizar').val();
          objetivo_realizar=$('#objetivo_realizar').val();
          material_utilizar=$('#material_utilizar').val();
          observaciones=$('#observaciones').val();
            agregardatos(numero,fecha_programada,actividad_realizar,objetivo_realizar,material_utilizar,observaciones);
        });
