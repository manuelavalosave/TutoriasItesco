...
$carrera = $conexion->prepare("CALL documentos_tutor(:id)");
...
<div class="container">
 ...
 foreach($formatos as $formato1):?>
            ...
            <div class="card" style="border-color: #34495e; margin-bottom: 20px; max-height: 500px;">
                <div class="card-header h3 text-white" style="background-color: #34495e">Grupos de Tutor: <?php echo $u[0][0]; ?> <?php echo $u[0][1]; ?> <?php echo $u[0][2]; ?></div>
                        ...
                        <tbody> 
                           ...
                           <th>Semestre</th>
                            ...
                            <tr>
                             ...
                             <td><?php echo $carrera['semestre'];?></td>
                              <td><?php echo $carrera['grupo'];?></td>   <td>
                                    <a  href="../admin/ReportesTutores.php?id=<?php echo $carrera['id_gp']; ?>&id_user=<?php echo $_GET['id'];?>"><?php  echo $carrera['carrera']; ?></a>
                                </td>
                               <td><?php echo $carrera['meses'];?> <?php echo $carrera['anio'];?></td>
                            </tr>
                          <?php $cn++; } ?>
                        </tbody>
                    </table>
